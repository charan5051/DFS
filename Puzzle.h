...
public:
    ...
    bool isSafe(const State state,int row,int col,int num);
    void setData(int *data);
    bool backTrack();
    bool backTrackNextStep();
    ...
    bool UsedInRow(const State state, int row, int num);
    bool UsedInCol(const State state, int col, int num);
    bool UsedInBox(const State state, int boxStartRow, int boxStartCol, int num);
    bool FindEMPTYLocation(const State state,int& row, int& col);
};
